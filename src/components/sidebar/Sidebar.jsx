...
import { MdBarChart, MdClose, MdDashboard, MdHome, MdLock, MdPerson, MdShoppingCart } from  "react-icons/md";
    ...
    <SidebarWrap className={`${isSidebarOpen ? "sidebar-active": ""}`}>
      <div className="sidebar-content">
        <div className="sidebar-head">
          ...
          <button type="button" className="sidebar-close-btn" onClick={() => dispatch(setSidebarClose())}>
            <MdClose size={20} />
          </button>
        </div>
        <nav className="sidebar-nav scrollbar">
          <ul className="sidenav-list">
            ...
            <li className="sidenav-item">
              <Link className="sidenav-link">
                <span className="link-icon"><MdShoppingCart size={20} /></span>
                <span className="link-text">NFT Marketplace</span>
              </Link>
            </li>
            <li className="sidenav-item">
              <Link className="sidenav-link">
                <span className="link-icon"><MdBarChart size={24} /></span>
                <span className="link-text">Tables</span>
              </Link>
            </li>
            <li className="sidenav-item">
              <Link className="sidenav-link">
                <span className="link-icon"><MdDashboard size={20} /></span>
                <span className="link-text">Kanban</span>
              </Link>
            </li>
            <li className="sidenav-item">
              <Link className="sidenav-link">
                <span className="link-icon"><MdPerson size={22} /></span>
                <span className="link-text">Profile</span>
              </Link>
            </li>
            <li className="sidenav-item">
              <Link className="sidenav-link">
                <span className="link-icon"><MdLock size={20} /></span>
